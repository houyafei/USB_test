...
import com.example.administrator.myapplication.dialog.LibraryLinksDialog;
    ...
    private void showEnvironmentList() {
        ...
        adapter.setOnItemListener(new MyAdapter.OnItemListener() {
            ...
            public void onLongClickListerner(View view, int pos) {
                startActivity(new Intent(Main4Activity.this, Main41Activity.class));
            }
        });
    }
...
//                R.drawable.img01,R.drawable.chart,R.drawable.chart};
    ...
    /**
    *  Database,Library,nature,Science按钮连接到对应的官方网站上
    *
    */
        ...
        switch (view.getId()) {
            ...
            case R.id.database:
                Intent intent1 = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://thomsonreuters.com/en/products-services/scholarly-scientific-research/scholarly-search-and-discovery/web-of-science.html"));
                startActivity(intent1);
                break;

            case R.id.library:
                new LibraryLinksDialog().show(getFragmentManager(),"library");
                break;

            case R.id.nature:
                Intent intent3 = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://www.nature.com/index.html"));
                startActivity(intent3);
                break;

            case R.id.science:
                Intent intent4 = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://www.sciencemag.org/"));
